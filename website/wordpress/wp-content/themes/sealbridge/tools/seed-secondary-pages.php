...
$product_pages = [
    ['Electrical Enclosure Gaskets', 'electrical-enclosure-gaskets', 'Electrical enclosure gaskets for junction boxes, outdoor covers, and equipment housings. Supports IP rated enclosure gasket projects when the complete enclosure design is being evaluated.', 'Use this category when the buyer needs a gasket for an electrical box, enclosure cover, access panel, outdoor housing, or IP-rating support project. Confirm drawing, gasket path, thickness, compression target, material, quantity, and document needs.'],
    ['Control Cabinet Sealing Strips', 'control-cabinet-sealing-strips', 'Control cabinet sealing strips for cabinet doors, distribution cabinets, server cabinets, and NEMA enclosure gasket projects.', 'Use this category for cabinet door seals, edge seals, and long strip profiles. Confirm profile drawing, door gap, material, hardness or density, length, corner treatment, and installation method.'],
