...
$pages = [
    [
        ...
        'post_name' => 'materials',
        'post_type' => 'page',
        'post_content' => '<div class="material-reference-gallery">
<div class="material-reference-grid">
<figure><img src="/wp-content/themes/sealbridge/assets/materials/material-property-description-01-en.png" alt="English material property description page for NBR HNBR FKM EPDM and silicone" width="1600" height="2200" loading="lazy"><figcaption>Page 1: core sealing elastomers.</figcaption></figure>
<figure><img src="/wp-content/themes/sealbridge/assets/materials/material-property-description-02-en.png" alt="English material property description page for NR SBR IIR CR CSM and FLS" width="1600" height="2200" loading="lazy"><figcaption>Page 2: general-purpose and weathering elastomers.</figcaption></figure>
<figure><img src="/wp-content/themes/sealbridge/assets/materials/material-property-description-03-en.png" alt="English material property description page for FFPM ACM PU GLT FTP and AEM" width="1600" height="2200" loading="lazy"><figcaption>Page 3: specialty and high-performance elastomers.</figcaption></figure>
<figure><img src="/wp-content/themes/sealbridge/assets/materials/material-properties-comparison-04-en.png" alt="English rubber material properties comparison chart and temperature guide" width="1600" height="2200" loading="lazy"><figcaption>Page 4: comparison chart and temperature guide.</figcaption></figure>
</div>
</div>',
    ],
    [
...
<section class="factory-system-section" aria-labelledby="production-system-title"><h2 id="production-system-title">Production System</h2><p>The production reference covers incoming material inspection, mixing, cutting, forming, in-process inspection, optional trimming and post-curing, final inspection, packing, outgoing inspection, and shipment.</p><figure class="factory-process-figure"><img src="/wp-content/themes/sealbridge/assets/trust/factory-systems/production-process.webp" alt="Bilingual rubber sealing product production and inspection process" width="1100" height="1468" loading="lazy"><figcaption>Original bilingual production-process reference supplied in the production partner brochure.</figcaption></figure><h2>Inspection and Testing System</h2><p>Inspection equipment is reviewed against the project requirement. Available checks may include dimensional measurement, aging exposure, hardness, tensile or compression-related testing. The exact test plan must be confirmed for the selected material and gasket.</p><div class="factory-testing-grid"><figure><img src="/wp-content/themes/sealbridge/assets/trust/factory-systems/aging-test-oven.webp" alt="High-temperature aging test oven used for rubber material checks" width="519" height="527" loading="lazy"><figcaption>High-temperature aging test oven.</figcaption></figure><figure><img src="/wp-content/themes/sealbridge/assets/trust/factory-systems/optical-measurement.webp" alt="Optical dimensional measurement equipment operated in a rubber testing laboratory" width="521" height="769" loading="lazy"><figcaption>Optical dimensional measurement equipment.</figcaption></figure><figure><img src="/wp-content/themes/sealbridge/assets/trust/factory-systems/testing-equipment.webp" alt="Rubber material testing laboratory equipment and workbench" width="1064" height="552" loading="lazy"><figcaption>Material and physical-property testing workbench.</figcaption></figure></div></section>
...
<figure class="factory-certificate-reference"><a href="/wp-content/themes/sealbridge/assets/trust/certificates/iso-9001-2015-english-reference.webp" target="_blank" rel="noopener"><img src="/wp-content/themes/sealbridge/assets/trust/certificates/iso-9001-2015-english-reference.webp" alt="English ISO 9001 2015 certificate reference from a screened production partner" width="820" height="1598" loading="lazy"></a><figcaption><strong>Historical supplier certificate reference — not a current certification claim.</strong> The English ISO 9001:2015 certificate shown in the supplied brochure expired on 10 October 2025. A current certificate must be requested and verified before it is used for qualification or purchasing.</figcaption></figure>
...
$posts = [
    ['EPDM vs Silicone for Outdoor Enclosure Gaskets', 'epdm-vs-silicone-outdoor-enclosure-gaskets', 'EPDM foam and silicone gaskets are the two most common choices for outdoor enclosure sealing. The better option depends on weather exposure, UV, temperature range, compression force, and whether the project needs a more economical EPDM route or a softer silicone route.'],
    ['What Information Is Needed for a Custom Die Cut Gasket Quote?', 'custom-die-cut-gasket-quote-information', 'A useful quote request for custom die cut gaskets should include drawing, material, thickness, adhesive requirement, tolerance, quantity, application, and compliance needs. Clear inputs help suppliers avoid assumptions and reduce quotation cycles.'],
    ['Can a Gasket Be IP65 or IP66 Certified?', 'can-a-gasket-be-ip65-or-ip66-certified', 'An IP65 gasket or IP66 gasket should not be described as certified by itself. The IP rating belongs to the complete enclosure assembly under IEC 60529 test conditions. Gasket material and compression design can support the target, but the system must be verified as a whole.'],
    ['How to Choose Electrical Enclosure Gaskets for Outdoor Boxes', 'choose-electrical-enclosure-gaskets-outdoor-boxes', 'Electrical enclosure gasket selection should start from the box structure, cover compression, outdoor exposure, material aging, adhesive requirement, and document needs. EPDM foam and silicone gasket materials are common options for electrical enclosure gaskets and rubber gasket for electrical enclosures projects.'],
    ['Control Cabinet Door Seal Profiles: What Buyers Should Confirm', 'control-cabinet-door-seal-profiles', 'Control cabinet door seal projects usually need a profile drawing or sample, door gap, material, hardness, color, roll length, and corner joining requirement. These details help avoid quoting the wrong electrical panel door gasket or NEMA 4X enclosure gasket profile.'],
...
$article_bodies = [
    'epdm-vs-silicone-outdoor-enclosure-gaskets' => '<h2>Quick Choice</h2><p>Use EPDM foam when the project needs a practical outdoor enclosure gasket with good weather, ozone, aging, and water resistance. Use silicone when the enclosure sees broader temperature swings, stronger UV exposure, or softer compression requirements.</p><h2>When EPDM Is the Better Gasket</h2><p>EPDM is often a better fit for electrical enclosure gaskets, cabinet seals, and outdoor box projects where cost and weather resistance matter more than extreme temperature performance. It is also a common starting point for <a href="/products/epdm-foam-gaskets/">EPDM foam gaskets</a> and enclosure door sealing.</p><h2>When Silicone Is the Better Gasket</h2><p>Silicone is usually preferred for LED housings, electronics covers, and high- or low-temperature environments. Buyers comparing <a href="/products/silicone-gaskets/">silicone gaskets</a> against EPDM should confirm hardness, compression force, UV exposure, adhesive need, and document requirements before sampling.</p><h2>Buyer Takeaway</h2><p>Choose the material from the real enclosure design, not from search volume alone. For outdoor electrical enclosure gasket projects, the right answer usually depends on gap, closing force, exposure, and whether a softer or more economical seal is required.</p>',
    'custom-die-cut-gasket-quote-information' => '<h2>What Buyers Should Send</h2><p>Custom die cut gaskets are easiest to quote when the buyer sends a drawing, sample photo, material target, thickness, adhesive requirement, tolerance, quantity, and application environment.</p><h2>Why Requests Break Down</h2><p>Missing thickness, unclear adhesive backing, or an undefined assembly surface often forces extra quotation rounds. For adhesive backed die cut gaskets, the liner type, adhesive grade, and surface condition matter as much as the outline itself.</p><h2>Buyer Takeaway</h2><p>If you want a faster RFQ, list the gasket path, quantity, document needs, and whether the part is for an electrical enclosure, control cabinet, or junction box. That reduces wrong assumptions and makes the quotation easier to compare.</p>',
    'can-a-gasket-be-ip65-or-ip66-certified' => '<h2>Short Answer</h2><p>No. An IP65 gasket or IP66 gasket should not be called certified on its own. The IP rating belongs to the finished enclosure assembly after testing under IEC 60529 conditions.</p><h2>What the Gasket Actually Does</h2><p>The gasket supports the sealing interface. Compression, corner design, latch spacing, door stiffness, and surface flatness all influence whether the enclosure can maintain the target IP rating. This is why an <a href="/products/electrical-enclosure-gaskets/">electrical enclosure gasket</a> must be reviewed with the complete assembly.</p><h2>How Buyers Should Phrase the Need</h2><p>Use wording such as IP rated gasket, IP65 gasket, IP66 gasket, or IEC 60529 gasket only as a project requirement or support target. Do not claim the gasket alone is certified. Ask for the enclosure drawing, compression gap, and test target before sampling.</p><h2>Buyer Takeaway</h2><p>If the project is for a control cabinet or outdoor box, review the sealing system as a whole and confirm whether the target is the gasket design, the enclosure assembly, or a validation test result.</p>',
    'choose-electrical-enclosure-gaskets-outdoor-boxes' => '<h2>Start With the Enclosure</h2><p>Choosing electrical enclosure gaskets should start with the box structure, cover geometry, door gap, compression target, and outdoor exposure. The right electrical enclosure gasket is the one that fits the actual assembly, not just the catalog description.</p><h2>Common Material Paths</h2><p>EPDM foam is a common starting point for a rubber gasket for electrical enclosures because it supports weather resistance and stable compression. Silicone is a stronger choice when the enclosure needs softer closing force, wider temperature range, or better UV tolerance.</p><h2>What to Send for Quotation</h2><p>For useful comparison, send the enclosure drawing, gasket path, thickness, adhesive requirement, quantity, and document needs. If you are comparing <a href="/products/electrical-enclosure-gaskets/">electrical enclosure gaskets</a> against <a href="/products/epdm-foam-gaskets/">EPDM foam gaskets</a> or <a href="/products/silicone-gaskets/">silicone gaskets</a>, keep the same test target and compression assumptions.</p><h2>Buyer Takeaway</h2><p>Good enclosure gasket selection is mostly a fit-and-function problem. The material choice matters, but compression, latch pressure, and exposure conditions matter just as much.</p>',
    'control-cabinet-door-seal-profiles' => '<h2>What the Buyer Is Really Selecting</h2><p>Control cabinet door seal profiles are not just shapes. They determine how a cabinet sealing strip compresses, how the door closes, and whether the finished assembly can support a NEMA enclosure seal target.</p><h2>Common Search Terms</h2><p>Buyers often search for electrical panel door gasket, electrical cabinet door seal, gasketing control cabinets, or NEMA 4X enclosure gasket when they actually need a profile drawing, gap range, and material recommendation.</p><h2>Profile and Material Guidance</h2><p>EPDM is a common starting point for weather-exposed cabinet doors. Silicone may be better when softer compression or broader temperature performance is needed. Share the door gap, corner treatment, and strip length so the profile can be matched correctly.</p><h2>Buyer Takeaway</h2><p>Use the measured door gap and closing force to choose the profile instead of relying on appearance. If you need help deciding, compare the cabinet drawing with the matching <a href="/products/control-cabinet-sealing-strips/">control cabinet sealing strips</a> page first.</p>',
    'epdm-foam-gasket-with-adhesive-quote-parameters' => '<h2>What Matters Most</h2><p>An EPDM foam gasket with adhesive must be selected by thickness, density, compression gap, adhesive grade, liner type, and surface condition. The adhesive is part of the sealing system, not an afterthought.</p><h2>Best Use Cases</h2><p>Adhesive-backed EPDM foam works well for outdoor panels, access covers, and enclosure doors where clean placement and repeatable assembly matter. It is a common route for <a href="/products/adhesive-backed-die-cut-gaskets/">adhesive backed die cut gaskets</a> and related enclosure parts.</p><h2>What to Send for Quotation</h2><p>Provide the gasket path, thickness, density or compression requirement, adhesive preference, surface material, temperature exposure, and quantity. That gives the supplier enough detail to compare a pressure sensitive adhesive gasket option against a non-adhesive route.</p><h2>Buyer Takeaway</h2><p>For quick sampling, keep the adhesive and foam spec tied to the actual surface and environment. That avoids rework when the part reaches production.</p>',
    'silicone-gaskets-led-lighting-outdoor-electronics' => '<h2>Why Silicone Is Common</h2><p>Silicone gaskets are often chosen for LED lighting housings and outdoor electronics because they balance softness, UV stability, and a wider temperature range. Buyers searching for a silicone gasket for LED lighting usually need a part that seals without creating too much closing force.</p><h2>Solid Silicone or Silicone Foam</h2><p>Solid silicone is useful for molded or cut gaskets with stable elasticity. Silicone foam is often better when the LED gasket needs softer compression around lenses, covers, or light housings. Either way, confirm the housing drawing, compression gap, color, and exposure condition before sampling.</p><h2>Related Product Pages</h2><p>Use the <a href="/products/silicone-gaskets/">silicone gaskets</a> page when the buyer needs a general material route, and keep the lighting-housing page for application-specific wording.</p><h2>Buyer Takeaway</h2><p>For LED and outdoor electronics, silicone often wins when heat or UV is the main risk. For more economical outdoor projects, EPDM may still be enough if the temperature range is moderate.</p>',
    'adhesive-backed-die-cut-gaskets-fast-enclosure-assembly' => '<h2>Why Buyers Use This Route</h2><p>Adhesive backed die cut gaskets are popular when assembly speed, clean placement, and repeatable positioning matter. They are a good fit for junction boxes, electronic housings, enclosure covers, and panel builds that need a pressure sensitive adhesive gasket.</p><h2>What Must Be Confirmed</h2><p>Before sampling, confirm the material, thickness, adhesive grade, liner type, tolerance, and packing format. The right combination depends on the mounting surface and whether the part should be supplied as a sheet, kiss-cut part, or finished frame.</p><h2>How This Supports Quoting</h2><p>Custom die cut gaskets are easier to quote when the buyer sends a DXF, PDF, or CAD file together with quantity and application. For repeat orders, keep the same adhesive and dimensional assumptions tied to the enclosure drawing.</p><h2>Buyer Takeaway</h2><p>Fast assembly does not mean a generic adhesive will work everywhere. Match the adhesive to the surface, temperature, and installation method before volume production.</p>',
    'custom-rubber-gaskets-according-to-drawing-sample-quote' => '<h2>What Makes a Good Drawing-Based RFQ</h2><p>Custom rubber gaskets according to drawing should be quoted from the actual geometry, material, hardness, tolerance, and environment. A sample is useful, but a dimensioned drawing is better for repeatable production.</p><h2>Where These Parts Are Used</h2><p>This route covers molded seals, cut frames, and special custom rubber gaskets for enclosure covers, cabinet doors, and application-specific sealing projects.</p><h2>Buyer Takeaway</h2><p>Send the drawing, sample photos, expected quantity, inspection criteria, and any document requirements before asking for price. That reduces assumptions and improves the usefulness of the quotation.</p>',
];
...
foreach ($posts as $post) {
    $content = $article_bodies[$post[1]] ?? '<p>' . esc_html($post[2]) . '</p><h2>Buyer Takeaway</h2><p>Confirm the actual application, material data, assembly method, and document requirements before locking the specification.</p>';
    sealbridge_upsert_post([
        'post_title' => $post[0],
        'post_name' => $post[1],
        'post_type' => 'post',
