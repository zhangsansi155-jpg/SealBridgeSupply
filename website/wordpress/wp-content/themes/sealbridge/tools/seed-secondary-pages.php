...
<div class="workshop-grid"><figure><img src="/wp-content/themes/sealbridge/assets/trust/factory-screening.png" alt="Factory screening and sample review template"><figcaption>Screening reference: product fit, process route, sample response, and document support are reviewed together.</figcaption></figure><figure><img src="/wp-content/themes/sealbridge/assets/trust/workshop-glimpse.png" alt="Clean gasket workshop display illustration"><figcaption>Workshop reference: real supplier names, customer files, and restricted factory photos are shared only when permitted during project communication.</figcaption></figure></div>
...
<form class="quote-form"><label>Name<input type="text" name="name"></label><label>Email<input type="email" name="email"></label><label>WhatsApp<input type="tel" name="whatsapp" placeholder="+86 138 0000 0000"></label><label>Product Type<select name="product_type"><option>Electrical Enclosure Gasket</option><option>Control Cabinet Sealing Strip</option><option>EPDM Foam Gasket</option><option>Silicone Gasket</option><option>Adhesive Backed Die Cut Gasket</option><option>Custom Rubber Gasket</option></select></label><label>Project Details<textarea name="message" placeholder="Material, size, quantity, application, documents needed..."></textarea></label><button class="button" type="button">Prepare Quote Details</button></form>
<h2>Fast Contact Channels</h2>
<div class="contact-channel-grid"><a href="https://wa.me/8613800000000" target="_blank" rel="noopener"><strong>WhatsApp</strong><span>+86 138 0000 0000</span></a><a href="https://www.facebook.com/sealbridgesupply" target="_blank" rel="noopener"><strong>Facebook</strong><span>facebook.com/sealbridgesupply</span></a></div>',
    ],
    [
        'post_title' => 'Insights',
        'post_name' => 'insights',
...
$product_pages = [
    ...
    ['Silicone Gaskets', 'silicone-gaskets', 'Silicone rubber and silicone foam gaskets for high/low temperature, outdoor electronics, LED housings, and equipment covers.', 'Use this category when softness, UV exposure, temperature range, or silicone material is important. Confirm solid or foam silicone, hardness, color, temperature range, food/flame requirements, and adhesive surface treatment.'],
...
$product_seo_sections = [
    ...
    'control-cabinet-sealing-strips' => '<h2>Control Cabinet Door Seal Applications</h2><p>Control cabinet sealing strips are used for cabinet doors, distribution cabinets, electrical cabinets, server cabinets, telecom cabinets, and industrial panels. These parts help close door gaps, reduce dust ingress, protect edges, and maintain repeatable compression after frequent cabinet access.</p><h2>Profile and Material Options</h2><p>Typical cabinet door seal profiles include bulb seals, D-shape strips, U-channel edge seals, self-grip profiles, and custom extruded rubber profiles. EPDM rubber is a common starting point for general cabinet sealing, while silicone rubber may be selected for softer sealing or broader temperature conditions.</p><h2>Quote Details for Cabinet Seals</h2><p>Useful inputs include a profile drawing, sample photo, cabinet door gap, installation method, material, hardness or sponge density, color, roll length or cut length, corner joining requirement, packing method, and annual quantity.</p>',
    ...
    'silicone-gaskets' => '<h2>Silicone Gasket Applications</h2><p>Silicone gaskets and silicone rubber gaskets are commonly used for LED lighting housings, outdoor electronics, equipment covers, battery enclosures, high-temperature covers, and projects where softness, UV exposure, or temperature range is more important than lowest material cost.</p><h2>Solid Silicone and Silicone Foam</h2><p>Solid silicone can be used for molded or die-cut gasket parts where stable elasticity and temperature resistance are required. Silicone foam can be useful for softer compression sealing around covers, lenses, and electronic housings. Color, hardness, surface finish, adhesive treatment, and flame or food-grade requirements should be confirmed.</p><h2>Quote Details for Silicone Gaskets</h2><p>For quotation, provide a 2D or 3D drawing, solid or foam silicone preference, hardness, color, temperature exposure, UV condition, adhesive requirement, tolerance, quantity, and any compliance documents requested by the buyer.</p>',
...
foreach ($posts as $post) {
    sealbridge_upsert_post([
        ...
        'post_content' => '<p>' . esc_html($post[2]) . '</p><h2>Buyer Takeaway</h2><p>Confirm the actual application, material data, assembly method, and document requirements before locking the specification.</p>',
    ]);
}
